...
function checkInput(){
    var ptype = document.getElementById( "txortho" ).checked;
    if( ptype ) {
        projectionType = 1;
    }else{
        if( document.getElementById( "txpersp" ).checked )
            projectionType = 2;
    }

    var dtype = document.getElementById( "txwire" ).checked;
    if( dtype ){
        drawType = 1;
    }else{
        if( document.getElementById( "txsolid" ).checked )
            drawType = 2;
    }

    var hexcolor = document.getElementById( "txobjcolor" ).value.substring(1);
...
function initInterface(){
    ...
    document.getElementById("txobjcolor").addEventListener("input", function (event) {
